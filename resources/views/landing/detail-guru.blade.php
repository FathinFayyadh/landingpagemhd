...
<main class="page_content">
        ...
        ================================================== -->
        <section class="details_section mentor_details_section section_space_lg pb-0">
          <div class="container">
            <div class="row align-items-center">
                <h1 class="text-center mb-5">Detail Guru</h1>
              <div class="col col-lg-6">
                <div class="details_image image_widget">
                  <img src="{{ asset('landingpage//assets/images/mentor/profil1.jpeg') }}" alt="Collab – Online Learning Platform">
                </div>
              </div>
              <div class="col col-lg-6">
                <div class="details_content ps-lg-5">
                  <ul class="meta_info_list unordered_list mb-3">


                  </ul>
                  <h2 class="mentor_name">Abdul Rasyid S.Ag.Gr</h2>
                  <h4 class="mentor_designation">Guru Al-Islam/KMD Kemuhammadiyahan</h4>
                  <p>
            ...
            <div class="row">
                ...
                <div class="course_card style_2">
                  <div class="item_image">
                    <a href="course_details.html" data-cursor-text="View">
                      <img src="assets/images/course/course_image_1.jpg" alt="Collab – Online Learning Platform">
                    </a>
                  </div>
              ...
              <div class="col col-lg-4">
                <div class="course_card style_2">
                  <div class="item_image">
                    <a href="course_details.html" data-cursor-text="View">
                      <img src="assets/images/course/course_image_2.jpg" alt="Collab – Online Learning Platform">
                    </a>
                  </div>
                  <div class="item_content">
                    <div class="d-flex align-items-center justify-content-between mb-3">
              ...
              <div class="col col-lg-4">
                <div class="course_card style_2">
                  <div class="item_image">
                    <a href="course_details.html" data-cursor-text="View">
                      <img src="assets/images/course/course_image_3.jpg" alt="Collab – Online Learning Platform">
                    </a>
                  </div>
                  <div class="item_content">
                    <div class="d-flex align-items-center justify-content-between mb-3">
              ...
              <div class="btn_wrap d-block d-lg-none text-center pb-0">
                <a class="btn border_dark" href="course.html">
                  <span>
                    <small>Explore Courses</small>
                    <small>Explore Courses</small>
        ...
        ================================================== -->
        <section class="calltoaction_section">
          <div class="boxed_wrapper bg_dark overflow-hidden decoration_wrap">
            <div class="row align-items-center">
              <div class="col col-lg-7">
                <div class="section_heading">
                  <h2 class="heading_text text-white">
                    Get Ahead Faster in Your Career with our Mentors
                  </h2>
                  <p class="heading_description mb-0 text-white">
                    Consectetur purus ut faucibus pulvinar elementum integer enim neque. Sed risus pretium quam vulputate dignissim suspendisse.
                  </p>
                </div>
                <ul class="info_list unordered_list_block text-white">
                  ...
                  <li>
                    <i class="fas fa-caret-right"></i>
                    <span><b>Email:</b> a.edwards@example.com</span>
                  </li>
                  <li>
                    <i class="fas fa-caret-right"></i>
                    <span><b>Phone:</b> (647) 517 910 521</span>
                  </li>
                </ul>
            ...
            <div class="row justify-content-center">
                ...
                <div class="mentor_item">
                  <div class="mentor_image">
                    <a href="mentor_details.html">
                      <img src="assets/images/mentor/mentor_image_5.jpg" alt="Collab – Online Learning Platform">
                    </a>
                  </div>
              ...
              <div class="col col-lg-4 col-md-6">
                <div class="mentor_item">
                  <div class="mentor_image">
                    <a href="mentor_details.html">
                      <img src="assets/images/mentor/mentor_image_6.jpg" alt="Collab – Online Learning Platform">
                    </a>
                  </div>
                  <div class="mentor_content">
                    <h3 class="mentor_name">
