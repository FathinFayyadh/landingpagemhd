              ...
              <div class="col col-lg-3 col-md-6 col-sm-6">
                <div class="footer_widget">
                  ...
                  <p class="text-white fs-6">
                    Sd Muhammadiyah 10 (Sudi Rejo I), Jl. H. Adenan Benawi No.66, Sudirejo I, Kec. Medan Kota, Kota Medan, Sumatera Utara 20216
                  </p>
              ...
              <div class="col col-lg-3 col-md-6 col-sm-6">
                <div class="footer_widget">
                  ...
                  <ul class="blog_small_group unordered_list_block">
                    ...
                    <li>
                      <a class="blog_small" href="blog_details.html">
                        <span class="item_image">x
                          <img src="{{asset("landingpage/Template/assets/images/")}}" alt="Collab – Online Learning Platform">
                        </span>
                        <span class="item_content">
                          <span class="item_author"><i class="fas fa-user-alt"></i> by Corabelle Durrad</span>
                          <strong class="item_title">See How Michaele Built a New Life and Career</strong>
        ...
        <div class="copyright_widget">
          <div class="container">
            <p class="copyright_text text-center mb-0">
              <a href="https://themeforest.net/user/merkulove">Copyrigth</a> © <b>2025</b> SD Muhammadiyah 10 Medan  |Build By Fathin Fayyadh
            </p>
          </div>
        </div>
      </footer>
